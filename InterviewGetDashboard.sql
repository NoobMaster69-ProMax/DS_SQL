...
/* ============================================================
   Interview Dashboard - ChartData Getter (Serenity compatible)
   Similar pattern to Dashboard_HumanResourceDashboard_Get_ChartData_1

   @Filter:
     string like: "DivisionID=1 AND FormattedDate='2026-01'"
     or whatever format your dbo.Dashboard_ColumnNameValue_TVF(@Filter) supports

   @Structure:
     0 = return data (default)
     1 = debug: SELECT TOP 1 *
     2 = return structure (comma-separated "col type")
   ============================================================ */
